			...
			<div class="card-body">
			  <form method="POST" action="{{ route('vendor.store') }}" enctype="multipart/form-data">
				...
				<div class="row mb-3">
				  ...
				  <div class="col-sm-10">
					<input required type="text" name="owner_name" class="form-control" id="basic-default-name" placeholder="Owner" />
				  </div>
				</div>
				<div class="row mb-3">
				  <label class="col-sm-2 col-form-label" for="basic-default-company">Vendor Name :</label>
				  <div class="col-sm-10">
					<input required type="text" name="vendor_name" class="form-control" id="basic-default-company" placeholder="Vendor" />
				  </div>
				</div>
