...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard / </span>PROCESSING DELIVERY</h4>
            ...
            <div class="row">
                ...
                <div class="col-xxl">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('vendor.complete.store', $delivery->id) }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input readonly type="text" class="form-control"
                                            id="basic-default-address" value="{{ $delivery->dropRider->rider_name }}" />
                                        <input name="drop_rider" type="hidden" class="form-control"
                                            id="basic-default-address" value="{{ $delivery->drop_rider }}" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            <select id="status" name="delivery_des" class="form-control">
