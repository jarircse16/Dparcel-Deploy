            ...
            <div class="row">
                ...
                <div class="col-xxl">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('processing.pickup.store', $pick_drop->id) }}">
                                @csrf
								@method('PUT')
								...
								<div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            <select id="pick_rider" name="pick_rider" class="form-control">
                                                <option disabled selected="selected">{{$pick_drop->pickRider->rider_name}}</option>
