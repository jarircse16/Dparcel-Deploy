            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('rider.register.store') }}">
                            @csrf

							<div class="mb-3">
                                <!-- <label for="email" class="form-label">Email or Username</label> -->
                                <input  class="form-control" id="email" type="text" name="rider_name"
                                    placeholder="Rider Name" autofocus />
                            </div>
							...
							<div class="mb-3">
                                <!-- <label for="email" class="form-label">Email or Username</label> -->
                                <input  class="form-control" id="email" type="text" name="address"
