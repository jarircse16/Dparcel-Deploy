...
<head>
    ...
    <title>Rider Rest Password</title>
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('rider.reset.password.store', $rider->id) }}">
                            @csrf
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-50 mx-auto" type="submit">Save Password</button>
                            </div>
                        </form>
                    </div>
                </div>
