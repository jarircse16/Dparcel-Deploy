...
<head>
    ...
    <title>Rider Forget Password</title>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                <img src="{{ asset('customer/img/logo/dmanLogoDark.png') }}" alt="">

                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-3 text-center">Forget Password</h4>

                        <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('rider.forget.password.store') }}">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-50 mx-auto" type="submit">Send Mail</button>
                            </div>
                        </form>

                        <p class="text-center">
                            <span>Did You want to Login</span>
